                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="service-box-layout7">
                            ...
                            <div class="item-content">
                                <h3 class="item-title">Bádogozás</h3>
                                <p>Egy olyan ereszcsatornát szeretne, amely tökéletesen elvégzi feladatát és a megjelenése is kiváló?</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="service-box-layout7">
                            ...
                            <div class="item-content">
                                ...
                                <p>Ha nincs az épületben garázsnak hely – vagy van, de már nem elegendő...</p>
                                <a href="garage.php" class="ghost-btn-md primary-border text-Primary">Bővebben<i class="fas fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="service-box-layout7">
                            ...
                            <div class="item-content">
                                <h3 class="item-title">Tetőtér beépítés</h3>
                                <p>A tetőtér-beépítés egy nagyobb átalakítást jelent otthonunkban, de ezt bízza ránk!
                                    </p>
                                <a href="single-service1.html" class="ghost-btn-md primary-border text-Primary">Bővebben<i class="fas fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
